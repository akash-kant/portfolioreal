...
const Footer = () => {
  ...
  const services = [
    { name: 'Resume Review', href: ROUTES.SERVICES },
    { name: 'Mock Interviews', href: ROUTES.SERVICES },
    { name: 'Career Consultation', href: ROUTES.SERVICES },
    { name: 'Mentorship', href: ROUTES.SERVICES }
  ]
